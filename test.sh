...
export CATEGORY_SEEDCONCEPTS=taxonomy_signal_processing.txt
export MODEL='ARL'
...
python conceptGraphPPR.py $SEGGED_TEXT_phrase_as_word_retain_alphanumeric $CATEGORY_SEEDCONCEPTS $SEGGED_TEXT_categorized $USE_CONCEPT_GRAPH
